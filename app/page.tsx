...
const work = [
  {
    ...
    text:
      "DynNav is a self-directed research initiative exploring risk-aware robotic navigation in dynamic environments. The project was shaped after academic discussion and developed independently, with a focus on ROS2-based experimentation, reinforcement learning, multi-agent coordination, and decision making under uncertainty.",
    details: ["Type: Independent research initiative", "Status: Active", "Focus: Risk-aware navigation"],
...
const skillGroups = [
  {
    ...
    items: ["Machine Learning", "Computer Vision", "Data Analysis", "Forecasting"],
  },
  {
    title: "Robotics & Autonomy",
    items: ["ROS2", "Motion Planning", "Navigation", "Multi-Agent Systems"],
  },
  {
        ...
        <section id="top" className="grid gap-12 py-24 md:grid-cols-[1fr_0.42fr] md:items-start md:py-32">
          <div>
            ...
            <h1 className="mt-7 max-w-4xl text-5xl font-semibold tracking-[-0.055em] text-stone-950 md:text-7xl md:leading-[0.95]">
              Machine learning and robotics for autonomous systems.
            </h1>
            <p className="mt-8 max-w-3xl text-lg leading-9 text-stone-700 md:text-xl md:leading-10">
              Research-oriented Electrical & Computer Engineering student focused on trajectory prediction, risk-aware navigation, and intelligent decision making under uncertainty.
            </p>

            <div className="mt-8 flex max-w-3xl flex-wrap gap-2">
              {researchInterests.map((interest) => (
                <span key={interest} className="border border-emerald-800/20 bg-white/70 px-3 py-1.5 text-xs font-medium text-emerald-900 shadow-[0_12px_35px_-32px_rgba(21,128,61,0.6)]">
                  {interest}
                </span>
              ))}
            </div>
          ...
          <aside className="h-fit border border-stone-200 bg-white/75 p-7 text-sm shadow-[0_24px_80px_-55px_rgba(41,37,36,0.65)] backdrop-blur">
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="border-l border-stone-300 pl-4">
                <p className="text-stone-500">Research initiative</p>
          ...
          <article className="grid gap-8 md:grid-cols-[1fr_0.36fr]">
            <div className={cardClass}>
              ...
              <p className="mt-6 text-lg leading-9 text-stone-700">
                The objective of this thesis is to investigate future trajectory prediction for vulnerable road users in smart-intersection environments. The research focuses on motion forecasting, uncertainty-aware modelling, and data-driven methods that can support safer decision making in autonomous driving systems.
              </p>
