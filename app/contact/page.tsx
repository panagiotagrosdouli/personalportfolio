          ...
          <div className="mt-14 grid gap-16 lg:grid-cols-2">
            <div>
              <p className="text-lg leading-9 text-stone-700 md:text-xl md:leading-10">
                I am an Electrical & Computer Engineering student with research interests in trajectory prediction, autonomous systems, and intelligent transportation. I welcome conversations about graduate research, robotics, machine learning, and research collaborations.
              </p>
