...
import { ResearchFigure } from "@/components/portfolio/ResearchFigure";

export function ResearchV6() {
  return (
        ...
        <div className="grid gap-8 lg:grid-cols-[0.38fr_0.62fr] lg:items-end">
          <div>
            ...
            <h2 className="mt-4 font-serif text-4xl leading-tight tracking-[-0.04em] text-stone-950 md:text-6xl">
              Human motion prediction at smart intersections.
            </h2>
          </div>
          <p className="max-w-3xl text-lg leading-9 text-stone-700">
            My diploma thesis studies future-motion prediction for intelligent transportation systems, with a focus on safer autonomous decision making around people.
          </p>
        </div>

        <div className="mt-10 grid gap-8 lg:grid-cols-[0.58fr_0.42fr]">
