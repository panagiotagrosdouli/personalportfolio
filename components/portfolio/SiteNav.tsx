    ...
    <nav className="sticky top-0 z-30 border-b border-stone-200 bg-[#fbfaf7]/90 px-6 py-5 text-xs font-semibold uppercase tracking-[0.22em] text-stone-500 backdrop-blur md:px-10 lg:px-12">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center rounded-full border border-stone-300 px-4 py-2 text-[0.68rem] text-stone-800 transition hover:border-emerald-900 hover:text-emerald-950 md:hidden"
